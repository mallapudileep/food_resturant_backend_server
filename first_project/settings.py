...
SECRET_KEY = 'django-insecure-$tmr-*&k%x6db-8f3&7-2#o##rv0%zf=l^m#%fsh56s!y99&_w'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.onrender.com','https://food-court-woad-nine.vercel.app/']
...
INSTALLED_APPS = [
    ...
    'flipkart', #this is another way to accesss the html page using registering
    'myntra',
    'demoapp'
]
