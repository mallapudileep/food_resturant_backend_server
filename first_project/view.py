...
def your(self):
    return JsonResponse({'name':'Dileep','age':20}) #this is Json Response we are given in the url path we have another in json response

def king(self):
    return JsonResponse(data.a) #this is the another method of data is accessing from the other file  
